...
class FakeLocalDataImp @Inject constructor(): FakeLocalData{
    ...
    companion object{
        ...
        private const val HISTORY2 = "The Marvel Comics API allows developers everywhere to access information about Marvel's vast library of comics—from what's coming up, to 70 years ago. "
